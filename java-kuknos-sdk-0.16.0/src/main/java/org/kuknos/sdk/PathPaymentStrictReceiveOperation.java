...
public class PathPaymentStrictReceiveOperation extends Operation {
  ...
  org.kuknos.sdk.xdr.Operation.OperationBody toOperationBody() {
    ...
    sendMax.setInt64(toXdrAmount(this.sendMax));
    ...
    destAmount.setInt64(toXdrAmount(this.destAmount));
  ...
  public static class Builder {
    ...
    Builder(PathPaymentStrictReceiveOp op) {
      ...
      sendMax = fromXdrAmount(op.getSendMax().getInt64().longValue());
      destination = StrKey.encodeStellarMuxedAccount(op.getDestination());
      destAsset = Asset.fromXdr(op.getDestAsset());
      destAmount = fromXdrAmount(op.getDestAmount().getInt64().longValue());
