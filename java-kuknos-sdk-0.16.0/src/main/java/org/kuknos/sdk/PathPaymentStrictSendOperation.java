...
import org.kuknos.sdk.xdr.PathPaymentStrictSendOp;
...
public class PathPaymentStrictSendOperation extends Operation {
  ...
  org.kuknos.sdk.xdr.Operation.OperationBody toOperationBody() {
    ...
    sendAmount.setInt64(toXdrAmount(this.sendAmount));
    ...
    destMin.setInt64(toXdrAmount(this.destMin));
    op.setDestMin(destMin);
    // path
    org.kuknos.sdk.xdr.Asset[] path = new org.kuknos.sdk.xdr.Asset[this.path.length];
  ...
  public static class Builder {
    ...
    Builder(PathPaymentStrictSendOp op) {
      ...
      sendAmount = fromXdrAmount(op.getSendAmount().getInt64().longValue());
      destination = StrKey.encodeStellarMuxedAccount(op.getDestination());
      destAsset = Asset.fromXdr(op.getDestAsset());
      destMin = fromXdrAmount(op.getDestMin().getInt64().longValue());
