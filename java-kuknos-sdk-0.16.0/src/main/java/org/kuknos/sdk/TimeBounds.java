...
import org.kuknos.sdk.xdr.TimePoint;
...
final public class TimeBounds {
	...
	public static TimeBounds fromXdr(org.kuknos.sdk.xdr.TimeBounds timeBounds) {
		if (timeBounds == null) {
			return null;
		}
	...
	public org.kuknos.sdk.xdr.TimeBounds toXdr() {
		org.kuknos.sdk.xdr.TimeBounds timeBounds = new org.kuknos.sdk.xdr.TimeBounds();
