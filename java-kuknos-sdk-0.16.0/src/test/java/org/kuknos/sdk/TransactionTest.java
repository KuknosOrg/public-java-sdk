...
public class TransactionTest {
    ...
    public void testMissingOperationFee() {
        ...
        try {
            new org.kuknos.sdk.Transaction.Builder(account, Network.TESTNET)
                .addOperation(new CreateAccountOperation.Builder("GDW6AUTBXTOC7FIKUO5BOO3OGLK4SF7ZPOBLMQHMZDI45J2Z6VXRB5NR", "2000").build())
                .setTimeout(org.kuknos.sdk.Transaction.Builder.TIMEOUT_INFINITE)
                .build();
    ...
    public void testBuilderSuccessTestnet() throws FormatException {
        ...
        org.kuknos.sdk.Transaction transaction = new org.kuknos.sdk.Transaction.Builder(account, Network.TESTNET)
                .addOperation(new CreateAccountOperation.Builder(destination.getAccountId(), "2000").build())
                .setTimeout(org.kuknos.sdk.Transaction.Builder.TIMEOUT_INFINITE)
                .setBaseFee(org.kuknos.sdk.Transaction.MIN_BASE_FEE)
                .build();
        ...
        org.kuknos.sdk.Transaction transaction2 = (org.kuknos.sdk.Transaction) org.kuknos.sdk.Transaction.fromEnvelopeXdr(transaction.toEnvelopeXdr(), Network.TESTNET);
    ...
    public void testBuilderTimeBounds() throws FormatException, IOException {
        ...
        Transaction decodedTransaction = Transaction.decode(is);
    ...
    public void testBuilderBaseFeeThrows() throws FormatException {
        ...
        Account account = new Account(source.getAccountId(), 2908908335136768L);
        org.kuknos.sdk.Transaction.Builder builder = new org.kuknos.sdk.Transaction.Builder(account, Network.TESTNET);
        try {
    ...
    public void testBuilderSuccessPublic() throws FormatException {
        ...
        Account account = new Account(source.getAccountId(), 2908908335136768L);
        org.kuknos.sdk.Transaction transaction = new org.kuknos.sdk.Transaction.Builder(account, Network.PUBLIC)
                .addOperation(new CreateAccountOperation.Builder(destination.getAccountId(), "2000").build())
                .setTimeout(org.kuknos.sdk.Transaction.Builder.TIMEOUT_INFINITE)
                .setBaseFee(org.kuknos.sdk.Transaction.MIN_BASE_FEE)
                .build();
    ...
    public void testNoNetworkSet() throws FormatException {
        ...
        Account account = new Account(source.getAccountId(), 2908908335136768L);
        try {
            new org.kuknos.sdk.Transaction.Builder(account, null)
                    .addOperation(new CreateAccountOperation.Builder(destination.getAccountId(), "2000").build())
                    .addMemo(Memo.none())
                    .setTimeout(org.kuknos.sdk.Transaction.Builder.TIMEOUT_INFINITE)
                    .build();
