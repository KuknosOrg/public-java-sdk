...
public abstract class Operation {
  ...
  public org.kuknos.sdk.xdr.Operation toXdr() {
    org.kuknos.sdk.xdr.Operation xdr = new org.kuknos.sdk.xdr.Operation();
  ...
  public String toXdrBase64() {
    try {
      org.kuknos.sdk.xdr.Operation operation = this.toXdr();
      ByteArrayOutputStream outputStream = new ByteArrayOutputStream();
      XdrDataOutputStream xdrOutputStream = new XdrDataOutputStream(outputStream);
      org.kuknos.sdk.xdr.Operation.encode(xdrOutputStream, operation);
   ...
   */
  public static Operation fromXdr(org.kuknos.sdk.xdr.Operation xdr) {
    org.kuknos.sdk.xdr.Operation.OperationBody body = xdr.getBody();
    Operation operation;
   ...
   */
  abstract org.kuknos.sdk.xdr.Operation.OperationBody toOperationBody();
}
