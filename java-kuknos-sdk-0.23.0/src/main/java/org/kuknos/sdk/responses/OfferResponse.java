...
public class OfferResponse extends Response implements Pageable {
  ...
  public OfferResponse(Long id, String pagingToken, String seller, Asset selling, Asset buying, String amount,Price_r price_r, String price, Integer lastModifiedLedger, String lastModifiedTime, String sponsor, Links links) {
    this.id = id;
