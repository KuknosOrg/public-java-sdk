...
public class AssetTest {
  ...
  public void testAssetTypeNative() {
    ...
    Asset xdr = asset.toXdr();
    org.kuknos.sdk.Asset parsedAsset = org.kuknos.sdk.Asset.fromXdr(xdr);
  ...
  public void testAssetTypeCreditAlphaNum4() {
    ...
    Asset xdr = asset.toXdr();
    AssetTypeCreditAlphaNum4 parsedAsset = (AssetTypeCreditAlphaNum4) org.kuknos.sdk.Asset.fromXdr(xdr);
  ...
  public void testAssetTypeCreditAlphaNum12() {
    ...
    Asset xdr = asset.toXdr();
    AssetTypeCreditAlphaNum12 parsedAsset = (AssetTypeCreditAlphaNum12) org.kuknos.sdk.Asset.fromXdr(xdr);
    assertEquals(code, asset.getCode());
    assertEquals(issuer.getAccountId(), parsedAsset.getIssuer());
  }
