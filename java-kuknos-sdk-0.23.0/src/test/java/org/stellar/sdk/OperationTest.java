...
import org.kuknos.sdk.Account;
import org.kuknos.sdk.AccountMergeOperation;
import org.kuknos.sdk.AllowTrustOperation;
import org.kuknos.sdk.Asset;
import org.kuknos.sdk.AssetCodeLengthInvalidException;
import org.kuknos.sdk.AssetTypeCreditAlphaNum12;
import org.kuknos.sdk.AssetTypeCreditAlphaNum4;
...
import org.kuknos.sdk.FormatException;
...
public class OperationTest {
    ...
    public void testCreateAccountOperation() throws FormatException, IOException, AssetCodeLengthInvalidException {
        ...
        Operation xdr = operation.toXdr();
        CreateAccountOperation parsedOperation = (CreateAccountOperation) org.kuknos.sdk.Operation.fromXdr(xdr);
    ...
    public void testPaymentOperation() throws FormatException, IOException, AssetCodeLengthInvalidException {
        ...
        Operation xdr = operation.toXdr();
        PaymentOperation parsedOperation = (PaymentOperation) org.kuknos.sdk.Operation.fromXdr(xdr);
    ...
    public void testPathPaymentStrictReceiveOperation() throws FormatException, IOException, AssetCodeLengthInvalidException {
        ...
        Operation xdr = operation.toXdr();
        PathPaymentStrictReceiveOperation parsedOperation = (PathPaymentStrictReceiveOperation) org.kuknos.sdk.Operation.fromXdr(xdr);
    ...
    public void testPathPaymentStrictSendOperation() throws FormatException, IOException, AssetCodeLengthInvalidException {
        ...
        Operation xdr = operation.toXdr();
        PathPaymentStrictSendOperation parsedOperation = (PathPaymentStrictSendOperation) org.kuknos.sdk.Operation.fromXdr(xdr);
    ...
    public void testChangeTrustOperation() throws FormatException, IOException {
        ...
        Operation xdr = operation.toXdr();
        ChangeTrustOperation parsedOperation = (ChangeTrustOperation) org.kuknos.sdk.Operation.fromXdr(xdr);
    ...
    public void testAllowTrustOperation() throws IOException, FormatException {
        ...
        Operation xdr = operation.toXdr();
        AllowTrustOperation parsedOperation = (AllowTrustOperation) org.kuknos.sdk.Operation.fromXdr(xdr);
    ...
    public void testManageSellOfferOperation_BadArithmeticRegression() throws IOException {
        ...
        ManageSellOfferOperation op = (ManageSellOfferOperation) org.kuknos.sdk.Operation.fromXdr(transactionEnvelope.getV0().getTx().getOperations()[0]);
    ...
    public void testManageBuyOfferOperation_BadArithmeticRegression() throws IOException {
        ...
        ManageBuyOfferOperation op = (ManageBuyOfferOperation) org.kuknos.sdk.Operation.fromXdr(transactionEnvelope.getV0().getTx().getOperations()[0]);
    ...
    public void testAccountMergeOperation() throws IOException, FormatException {
        ...
        AccountMergeOperation parsedOperation = (AccountMergeOperation) org.kuknos.sdk.Operation.fromXdr(xdr);
    ...
    public void testManageDataOperation() throws IOException, FormatException {
        ...
        ManageDataOperation parsedOperation = (ManageDataOperation) org.kuknos.sdk.Operation.fromXdr(xdr);
    ...
    public void testBumpSequence() throws IOException, FormatException {
        ...
        BumpSequenceOperation parsedOperation = (BumpSequenceOperation) org.kuknos.sdk.Operation.fromXdr(xdr);
    ...
    public void testToXdrAmount() {
        assertEquals(0L, org.kuknos.sdk.Operation.toXdrAmount("0"));
        assertEquals(1L, org.kuknos.sdk.Operation.toXdrAmount("0.0000001"));
        assertEquals(10000000L, org.kuknos.sdk.Operation.toXdrAmount("1"));
        assertEquals(11234567L, org.kuknos.sdk.Operation.toXdrAmount("1.1234567"));
        assertEquals(729912843007381L, org.kuknos.sdk.Operation.toXdrAmount("72991284.3007381"));
        assertEquals(729912843007381L, org.kuknos.sdk.Operation.toXdrAmount("72991284.30073810"));
        assertEquals(1014016711446800155L, org.kuknos.sdk.Operation.toXdrAmount("101401671144.6800155"));
        assertEquals(9223372036854775807L, org.kuknos.sdk.Operation.toXdrAmount("922337203685.4775807"));

        try {
            org.kuknos.sdk.Operation.toXdrAmount("0.00000001");
            fail();
        ...
        try {
            org.kuknos.sdk.Operation.toXdrAmount("72991284.30073811");
            fail();
        } catch (ArithmeticException e) {
        } catch (Exception e) {
            fail();
    ...
    public void testFromXdrAmount() {
        assertEquals("0", org.kuknos.sdk.Operation.fromXdrAmount(0L));
        assertEquals("0.0000001", org.kuknos.sdk.Operation.fromXdrAmount(1L));
        assertEquals("1", org.kuknos.sdk.Operation.fromXdrAmount(10000000L));
        assertEquals("1.1234567", org.kuknos.sdk.Operation.fromXdrAmount(11234567L));
        assertEquals("72991284.3007381", org.kuknos.sdk.Operation.fromXdrAmount(729912843007381L));
        assertEquals("101401671144.6800155", org.kuknos.sdk.Operation.fromXdrAmount(1014016711446800155L));
        assertEquals("922337203685.4775807", org.kuknos.sdk.Operation.fromXdrAmount(9223372036854775807L));
    }
    ...
    public void testInflationOperation() {
        ...
        Operation xdr = operation.toXdr();
        InflationOperation parsedOperation = (InflationOperation) org.kuknos.sdk.Operation.fromXdr(xdr);
    ...
    public void testClaimClaimableBalanceOperationValid() {
        ...
        Operation xdr = operation.toXdr();
        ClaimClaimableBalanceOperation parsedOperation = (ClaimClaimableBalanceOperation) org.kuknos.sdk.Operation.fromXdr(xdr);
    ...
    public void testRevokeAccountSponsorshipOperation() {
        ...
        Operation xdr = operation.toXdr();
        RevokeAccountSponsorshipOperation parsedOperation = (RevokeAccountSponsorshipOperation) org.kuknos.sdk.Operation.fromXdr(xdr);
    ...
    public void testRevokeDataSponsorshipOperation() {
        ...
        Operation xdr = operation.toXdr();
        RevokeDataSponsorshipOperation parsedOperation = (RevokeDataSponsorshipOperation) org.kuknos.sdk.Operation.fromXdr(xdr);
        assertEquals(accountId, parsedOperation.getAccountId());
        assertEquals(source, parsedOperation.getSourceAccount());
    ...
    public void testRevokeClaimableBalanceSponsorshipOperation() {
        ...
        Operation xdr = operation.toXdr();
        RevokeClaimableBalanceSponsorshipOperation parsedOperation = (RevokeClaimableBalanceSponsorshipOperation) org.kuknos.sdk.Operation.fromXdr(xdr);
        assertEquals(balanceId, parsedOperation.getBalanceId());
        assertEquals(source, parsedOperation.getSourceAccount());
    }
    ...
    public void testRevokeOfferSponsorshipOperation() {
        ...
        Operation xdr = operation.toXdr();
        RevokeOfferSponsorshipOperation parsedOperation = (RevokeOfferSponsorshipOperation) org.kuknos.sdk.Operation.fromXdr(xdr);
        assertEquals(offerId, parsedOperation.getOfferId());
    ...
    public void testRevokeSignerSponsorshipOperation() {
        ...
        Operation xdr = operation.toXdr();
        RevokeSignerSponsorshipOperation parsedOperation = (RevokeSignerSponsorshipOperation) org.kuknos.sdk.Operation.fromXdr(xdr);
        assertEquals(accountId, parsedOperation.getAccountId());
        assertEquals(source, parsedOperation.getSourceAccount());
    ...
    public void testRevokeTrustlineSponsorshipOperation() {
        ...
        Operation xdr = operation.toXdr();
        RevokeTrustlineSponsorshipOperation parsedOperation = (RevokeTrustlineSponsorshipOperation) org.kuknos.sdk.Operation.fromXdr(xdr);
        assertEquals(accountId, parsedOperation.getAccountId());
        assertEquals(source, parsedOperation.getSourceAccount());
